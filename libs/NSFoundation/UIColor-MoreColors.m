...
//red 0.069755, green 0.525995, blue 0.949327 藍
+ (id)seaBlue											{vendColor(0.069755*255, 0.525995*255, 0.949327*255);}
//red 0.512932, green 0.612640, blue 0.839112
+(UIColor *)randomColor
{
	//CGFloat red =  (CGFloat)arc4random()/(CGFloat)RAND_MAX;
	CGFloat red =   (CGFloat)arc4random()/ 0xffffffff;
